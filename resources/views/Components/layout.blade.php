        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <img src="https://www.speedgoat.io/wp-content/uploads/2018/02/speed-goat-logo.png" alt="Speedgoat Logo" class="h-10 w-full" />
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <a href="/" aria-current="page" class="{{ request()->is('/')  ? 'bg-gray-950/50 text-white': 'text-gray-300 hover:bg-white/5 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">Home</a>
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <el-dropdown class="relative ml-3">
                            <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                ...
                                <img src="https://www.speedgoat.io/wp-content/uploads/2018/07/josh_profile-e1532361701187.jpg" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                            </button>
                        </el-dropdown>
                    </div>
                </div>
        ...
        <el-disclosure id="mobile-menu" hidden class="block md:hidden">
            ...
            <div class="border-t border-white/10 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="shrink-0">
                        <img src="https://www.speedgoat.io/wp-content/uploads/2018/07/josh_profile-e1532361701187.jpg" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">Josh Nowak</div>
                        <div class="text-sm font-medium text-gray-400">josh@example.com</div>
                    </div>
